...
FINAL_IMAGE=${DISTDIR}/02.LED_SWITCH.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/02.LED_SWITCH.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
